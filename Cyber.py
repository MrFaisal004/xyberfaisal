...
\033[1;91m•───────────────────────────────────────────•
\033[1;97m•-----------------\033[1;37mCYBER FAISAL033[1;97m-----------------•
 \033[1;97m•▅▅▅▅▅▅▅▅▅▅▅▅▅▅▅▅▅▅▅▅▅▅▅▅▅▅
\033[1;41m\033[1;37m[\033[1;37mAuthor Name:CYBER FAISAL\033[1;37m]\033[1;0m
\033[1;97m•▅▅▅▅▅▅▅▅▅▅▅▅▅▅▅▅▅▅▅▅▅▅▅▅▅▅
\033[1;97m•-----------------\033[1;37mCYBER FAISAL  \033[1;97m-----------------•
"""

def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\x1b[1;93mCYBER_FAISAL█████████████████▒▒▒▒▒▒▒▒..99% \x1b[1;93m"+o),;sys.stdout.flush();time.sleep(0.1)
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:CyberFAISAL-Error404
	    time.sleep(2)
            loop = 'false'
        else:
...
def login1():
	...
	try:
		...
		os.system('clear')
                time.sleep(0.05)
		print logo                
		print "\033[1;97m•-----------------\033[1;37mCyber_FAISAL\033[1;97m-----------------•"
		...
		if 'save-device' in url:
			try:
				...
				unikers.close()
				print '\033[1;47m\033[1;91mCyber_FAISAL Login Successful\033[1;0m'
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:CyberFAISAL-Error404
	print logo
	...
	time.sleep(0.05)
	print "\033[1;94m[3]\033[1;47m\033[1;31mRest/Update Cyber_FAISAL                          \033[1;0m"
	time.sleep(0.05)
...
def pilih():
	...
	if unikers =="":
		...
		print "\033[1;95m...............\033[1;91mDataReset\033[1;95m.................."
                ...
                jalan('\033[1;95m=========90%')
                jalan('\033[1;94m==========100%')
                jalan('\033[1;93mCloning Data Reset and update by Cyber_FAISAL')
...
def pilih_super():
	...
	if peak =="":
		...
		print "\033[1;97m•-----------------\033[1;37mCyber_FAISAL\033[1;97m-----------------•"
		print logo
		jalan('\033[1;97m[+]\033[1;91mCyberFAISAL█████████████████▒▒▒▒▒▒▒▒..99%\033[1;97m:-:')
		...
		try:
			...
			super()
		print"\033[1;97m[+]\033[1;91mCyberFAISAL█████████████████▒▒▒▒▒▒▒▒..99%\033[1;97m:-:"
	...
	def main(arg):
		...
		try:
			...
			pass #Dev:CYBERFAISALr-Error404
		try:													
...
| $$            | $$  | $$              | $$               /$$  \ $$            | $$  | $$            | $$
| $$            | $$  | $$             /$$$$$$            |  $$$$$$/            | $$  | $$            | $$$$$$$$
|__/            |__/  |__/            |______/             \______/             |__/  |__/            |________/

"""
	print "\033[1;97m«-----------------\033[1;37mCyber_Faisal\033[1;97m-----------------»"
	raw_input("\n\033[1;97m[+]\033[1;97mFaisal")
	menu()
